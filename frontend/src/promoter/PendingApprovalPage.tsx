          ...
          {!isRejected ? (
            <>
              <p style={{ fontSize: 14, color: WM, lineHeight: 1.75, marginBottom: 24 }}>
                Your application is being reviewed by the HoneyGroup Promotions admin team. This typically takes
            ...
            <>
              <div style={{ background: 'rgba(200,112,96,0.08)', border: '1px solid rgba(200,112,96,0.25)', padding: '16px 20px', marginBottom: 20 }}>
                <p style={{ fontSize: 14, color: WM, lineHeight: 1.75 }}>
                  {status === 'blacklisted'
                    ? 'Your account has been suspended. Please contact the HoneyGroup Promotions admin team for further information.'
