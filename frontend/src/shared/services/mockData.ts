...
export const MOCK_PROFILES: UserProfileWithEmail[] = [
  ...
  {
    userId:      'lebo@campari.co.za',
    email:       'lebo@campari.co.za',
  ...
  {
    userId:      'thabo@campari.co.za',
    email:       'thabo@campari.co.za',
  ...
  // Pending promoter
  {
    userId:      'nomsa@campari.co.za',
    email:       'nomsa@campari.co.za',
    fullName:    'Nomsa Zulu',
  ...
  {
    userId:      'siya@campari.co.za',
    email:       'siya@campari.co.za',
  ...
  {
    userId:      'zandile@campari.co.za',
    email:       'zandile@campari.co.za',
  ...
  {
    userId:      'karabo@campari.co.za',
    email:       'karabo@campari.co.za',
...
export const MOCK_SHIFTS: Shift[] = [
  ...
  },
  {
    id: 's-006',
    jobId: 'j-007',
    promoterId: 'thabo@campari.co.za',
    attendance: {
      shiftId: 's-006',
      promoterId: 'thabo@campari.co.za',
      jobId: 'j-007',
